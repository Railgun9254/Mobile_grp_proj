...
public class stage_select extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        level3Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(stage_select.this, FindDifference1.class); // 找不同遊戲1
                startActivity(intent);
            }
        });
        ...
        level4Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(stage_select.this, FindDifference2.class); // 找不同遊戲2
                startActivity(intent);
            }
        });
        ...
        level11Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(stage_select.this, c4_bomb_game1.class); // Level 11 炸彈遊戲1
                startActivity(intent);
            }
        });
        ...
        level12Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(stage_select.this, c4_bomb_game2.class); // Level 12 炸彈遊戲2
                startActivity(intent);
            }
        });
    }
