...
public class FindDifferenceWin2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set level display
        levelSign.setText("Level 2 Complete");
     ...
     * For the last level, return to level selection
     */
    protected void onNextLevelButtonClicked() {
        // This is the final level, so return to level selection
